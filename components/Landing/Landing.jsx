    ...
    return (
        ...
        
        {
            screenDetected && (
                ...
                <div style={{width:"430px"}} className={`h-full rounded-[24px] bg-fuchsia-500 flex flex-col items-center ${false ? "justify-end gap-y-12":"justify-around"} overflow-hidden`}>
                <motion.div
